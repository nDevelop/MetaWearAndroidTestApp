        ...
        mwBoard.connectAsync()
                ...
                .continueWith(task -> {
                    if (!task.isCancelled()) {
                        ...
                        Intent mainActivityIntent  = new Intent(ScannerActivity.this, MainActivity.class);
                        mainActivityIntent .putExtra(MainActivity.EXTRA_BT_DEVICE, btDevice);
                        startActivityForResult(mainActivityIntent, REQUEST_START_APP);
                    }
                    return null;
                });
    }
